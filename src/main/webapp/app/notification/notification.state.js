    ...
    function stateConfig($stateProvider) {
        ...
        .state('notification', {
            ...
            data: {
                ...
                pageTitle: 'qualiMakerApp.notification.home.title'
            },
            views: {
                'content@': {
        ...
        .state('notification-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'qualiMakerApp.notification.detail.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/notification/notification-detail.html',
        ...
        .state('notification-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/notification/notification-dialog.html',
        ...
        .state('notification.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/notification/notification-delete-dialog.html',
