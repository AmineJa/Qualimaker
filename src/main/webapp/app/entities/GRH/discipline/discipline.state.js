    ...
    function stateConfig($stateProvider) {
        ...
        .state('discipline', {
            ...
            data: {
                ...
                pageTitle: 'qualiMakerApp.discipline.home.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/discipline/disciplines.html',
        ...
        .state('discipline-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'qualiMakerApp.discipline.detail.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/discipline/discipline-detail.html',
        ...
        .state('discipline-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/discipline/discipline-dialog.html',
        ...
        .state('discipline.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/discipline/discipline-delete-dialog.html',
