(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('sites', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/sites/sites.html',
        ...
        .state('sites-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/sites/sites-detail.html',
        ...
        .state('sites-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/sites/sites-dialog.html',
        ...
        .state('sites.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/sites/sites-delete-dialog.html',
