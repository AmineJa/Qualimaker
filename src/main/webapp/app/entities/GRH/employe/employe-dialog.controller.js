(function() {
    ...
    EmployeDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'DataUtils', 'entity', 'Employe', 'Carriere', 'Conge', 'Sites', 'Groupe', 'Serviice', 'Formation', 'Fonction'];

    function EmployeDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, DataUtils, entity, Employe, Carriere, Conge, Sites, Groupe, Serviice, Formation, Fonction) {
        var vm = this;
