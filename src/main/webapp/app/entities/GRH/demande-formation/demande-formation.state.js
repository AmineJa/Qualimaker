(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('demande-formation', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/demande-formation/demande-formations.html',
        ...
        .state('demande-formation-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/demande-formation/demande-formation-detail.html',
        ...
        .state('demande-formation-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/demande-formation/demande-formation-dialog.html',
        ...
        .state('demande-formation.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/demande-formation/demande-formation-delete-dialog.html',
