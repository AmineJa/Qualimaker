(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('nature-abs', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/nature-abs/nature-abs.html',
        ...
        .state('nature-abs-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/nature-abs/nature-abs-detail.html',
        ...
        .state('nature-abs-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/nature-abs/nature-abs-dialog.html',
        ...
        .state('nature-abs.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/nature-abs/nature-abs-delete-dialog.html',
