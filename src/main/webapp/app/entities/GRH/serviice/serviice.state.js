(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('serviice', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/serviice/serviices.html',
        ...
        .state('serviice-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/serviice/serviice-detail.html',
        ...
        .state('serviice-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/serviice/serviice-dialog.html',
        ...
        .state('serviice.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/serviice/serviice-delete-dialog.html',
