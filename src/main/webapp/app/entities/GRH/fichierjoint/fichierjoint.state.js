(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('fichierjoint', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/fichierjoint/fichierjoints.html',
        ...
        .state('fichierjoint-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/fichierjoint/fichierjoint-detail.html',
        ...
        .state('fichierjoint-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/fichierjoint/fichierjoint-dialog.html',
        ...
        .state('fichierjoint.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/fichierjoint/fichierjoint-delete-dialog.html',
