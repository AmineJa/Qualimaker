(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('formation', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/formation/formations.html',
        ...
        .state('formation-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/GRH/formation/formation-detail.html',
        ...
        .state('formation-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/formation/formation-dialog.html',
        ...
        .state('formation.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/GRH/formation/formation-delete-dialog.html',
