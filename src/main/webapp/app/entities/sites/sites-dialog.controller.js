(function() {
    ...
    SitesDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Sites', 'DocumentInterne'];

    function SitesDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Sites, DocumentInterne) {
        var vm = this;
