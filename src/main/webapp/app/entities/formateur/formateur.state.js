(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('formateur', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/formateur/formateurs.html',
        ...
        .state('formateur-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/formateur/formateur-detail.html',
        ...
        .state('formateur-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/formateur/formateur-dialog.html',
        ...
        .state('formateur.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/formateur/formateur-delete-dialog.html',
