(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('integre', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/integre/integres.html',
        ...
        .state('integre-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/integre/integre-detail.html',
        ...
        .state('integre-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/integre/integre-dialog.html',
        ...
        .state('integre.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/integre/integre-delete-dialog.html',
