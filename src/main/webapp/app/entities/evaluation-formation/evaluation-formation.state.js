(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('evaluation-formation', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/evaluation-formation/evaluation-formations.html',
        ...
        .state('evaluation-formation-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/evaluation-formation/evaluation-formation-detail.html',
        ...
        .state('evaluation-formation-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/evaluation-formation/evaluation-formation-dialog.html',
        ...
        .state('evaluation-formation.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/evaluation-formation/evaluation-formation-delete-dialog.html',
