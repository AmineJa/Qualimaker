(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('abscence', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/abscence/abscences.html',
        ...
        .state('abscence-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/abscence/abscence-detail.html',
        ...
        .state('abscence-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/abscence/abscence-dialog.html',
        ...
        .state('abscence.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/abscence/abscence-delete-dialog.html',
