(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('type-conge', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/type-conge/type-conges.html',
        ...
        .state('type-conge-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/type-conge/type-conge-detail.html',
        ...
        .state('type-conge-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/type-conge/type-conge-dialog.html',
        ...
        .state('type-conge.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/type-conge/type-conge-delete-dialog.html',
