...
/**
 * Performance test for the DemandeFormation entity.
 */
class DemandeFormationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the DemandeFormation entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all demandeFormations")
            .get("/api/demande-formations")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created demandeFormation")
                .get("${new_demandeFormation_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created demandeFormation")
            .delete("${new_demandeFormation_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
