...
/**
 * Performance test for the Abscence entity.
 */
class AbscenceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Abscence entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created abscence")
                .get("${new_abscence_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created abscence")
            .delete("${new_abscence_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
