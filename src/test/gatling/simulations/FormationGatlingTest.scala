...
/**
 * Performance test for the Formation entity.
 */
class FormationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Formation entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created formation")
                .get("${new_formation_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created formation")
            .delete("${new_formation_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
