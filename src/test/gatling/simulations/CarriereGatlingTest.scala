...
/**
 * Performance test for the Carriere entity.
 */
class CarriereGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Carriere entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created carriere")
                .get("${new_carriere_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created carriere")
            .delete("${new_carriere_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
